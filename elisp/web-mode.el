...
(defcustom web-mode-enable-auto-indentation nil   ; (display-graphic-p)
  "Auto-indentation."
  :type 'boolean
  :group 'web-mode)
...
;;; On retire "col" parce que ça nous embête lors de l'indentation
;;; des Generic Reports.
...
(defvar web-mode-start-tag-regexp "<\\([a-bA-B_$-][a-bA-B0-9:_$-]*\\)"
...
(defvar web-mode-regexp1 "<\\(/?[[:alpha:]$_][[:alnum:]$:-]*\\|!--\\|!\\[CDATA\\[\\|!doctype\\|!DOCTYPE\\|\?xml\\)")

(defvar web-mode-regexp2 "<\\(/?[[:alpha:]$_][[:alnum:]$:-]*\\|!--\\|!\\[CDATA\\[\\)")
         ...
         ((string= tname "script")
          (let (script)
            ...
            (cond
             ...
             ((string-match-p " type[ ]*=[ ]*[\"']text/\\(x-handlebars\\|html\\|ng-template\\|template\\|mustache\\)" script)
